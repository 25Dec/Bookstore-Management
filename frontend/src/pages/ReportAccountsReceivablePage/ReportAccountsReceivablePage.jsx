...
import "./ReportAccountsReceivablePage.css";

const ReportAccountsReceivablePage = () => {
	...
	return (
		<div id="ReportAccountsReceivablePage">
			<h1>Báo cáo công nợ</h1>
			<div
				id="addReportAccountsReceivableIcon"
				className="add"
				onClick={() => {
					toggleAddPayment();
				}}
...
export default ReportAccountsReceivablePage;
